...
- Excluded the Maldives from the South Asia regional comparison: a tourism microstate of roughly 500,000 people with a 2024 GDP per capita of $13,379, several times every other country in the set, which pulled the regional average up sharply and made Pakistan's gap look larger than the comparison against India, Bangladesh, Sri Lanka, Nepal, Bhutan, and Afghanistan actually supports
...
Pakistan was already below the South Asia average in 1990, and the gap widened after 2000 as India and Sri Lanka drove the regional average upward. Pakistan's trajectory shows boom-bust cycles rather than steady convergence. Pakistan's year-over-year GDP growth standard deviation (11.30%) is materially higher than the South Asia average (7.33%, Maldives excluded as an outlier microstate), though sparse overlapping data prevents a formal significance test. These figures are in current USD, and Pakistan's PKR has depreciated substantially over this period, so part of that volatility reflects exchange rate movement rather than real output swings alone. This pattern is still consistent with an economy reliant on volatile capital inflows, though testing that hypothesis directly would require additional data on remittances, exports, and sectoral composition.
...
As of 2024, Pakistan's GDP per capita stands at $1,479, 4th out of 5 South Asian countries with available data (Afghanistan and Bhutan lack reported 2024 GDP per capita; Maldives is excluded from this comparison as an outlier tourism microstate). It sits far below Sri Lanka ($4,516), India ($2,695), and Bangladesh ($2,593), and is close to Nepal ($1,447).
...
1. **Pakistan's GDP growth has been volatile and structurally lagging.** Pakistan has trailed the South Asia average in GDP per capita since 1990, with the gap widening after 2000. Pakistan's year-over-year GDP growth standard deviation (11.30%) is materially higher than the South Asia average (7.33%, Maldives excluded), though sparse overlapping data prevents a formal significance test, and part of this gap reflects PKR depreciation against the USD rather than real output volatility alone. India and Sri Lanka drove the regional average upward through steadier convergence.
